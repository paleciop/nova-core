...
/**
 * Outputs <tt>args</tt> to the console, adding '> NovaCore:' as prefix.
 * @param args The arguments to log.
 */
const log = (...args) => console.log('> Nova Core:', ...args);
 ...
 */
const isValidContextProcessor = contextProcessor => hasMethod(contextProcessor, 'process');
