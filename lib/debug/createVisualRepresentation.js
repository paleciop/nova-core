module.exports = debugObject => {
  ...
  const template = `
    ...
    <html lang="en">
      <head>
        <title>Context Processor Execution</title>
        <link rel="stylesheet"
  ...
  const newColumn = (color, name, size) => {
    ...
    switch (size) {
      case 1:
        classes = '-lg-8 col-center col-md-12';
        break;
      case 2:
  ...
  const heading = (title, initialContentModel) =>
    `<h2 class="text-center">${title}</h2><div class="row"><div class="col-3 col-center"><div class="context-processor text-center verde"><span><strong>Start execution</strong></span></div></div></div><div class="container-fluid level"></div><div class="row initial-content-model"><div class="col-6 col-center"><p class="text-center input">${initialContentModel}</p></div></div>`;
  ...
  contents += `<div class="container-fluid level last"><div class="row initial-content-model">`;
  contents += newColumn(
    colors[1],
